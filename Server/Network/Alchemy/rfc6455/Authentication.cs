...
using Server.Network.Alchemy.Handlers.Socket.hybi00;

namespace Server.Network.Alchemy.Handlers.Socket.rfc6455
{
    /// <summary>
    ...
    internal class Authentication : Handlers.Authentication
    {
        ...
        private static ServerHandshake GenerateResponseHandshake(ClientHandshake handshake, SocketServer server)
        {
