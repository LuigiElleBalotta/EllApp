...
using Server.Network.Alchemy.Handlers;
...
namespace Server.Network.Alchemy
{
    ...
    /// </summary>
    public class SocketServer : TcpServer, IDisposable
    {
        ...
        private static Dictionary<Context, SocketServer> ContextMapping { get; set; }
        ...
        static SocketServer()
        {
            ...
            ContextMapping = new Dictionary<Context, SocketServer>();
        ...
        private static void HandleClientThread()
        {
            while (!cancellation.Token.IsCancellationRequested)
            {
                ...
                lock (ContextMapping)
                {
                    SocketServer client = ContextMapping[context];
        ...
        /// </summary>
        public SocketServer(int listenPort = 0, IPAddress listenAddress = null) : base(listenPort, listenAddress) {}
