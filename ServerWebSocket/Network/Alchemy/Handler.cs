...
using Server.Network.Alchemy.Handlers.Socket;

namespace Server.Network.Alchemy.Handlers
{
    /// <summary>
            ...
            else //If it isn't, process http/websocket header as normal.
            {
                ...
                switch (context.Header.Protocol)
                {
                    case Protocol.WebSocketHybi00:
                        ...
                        context.Handler = Socket.hybi00.Handler.Instance;
                        context.UserContext.DataFrame = new Socket.hybi00.DataFrame();
                        context.Handler.RegisterContext(context);
                        break;
                    case Protocol.WebSocketRFC6455:
                        context.Handler.UnregisterContext(context);
                        context.Handler = Socket.rfc6455.Handler.Instance;
                        context.UserContext.DataFrame = new Socket.rfc6455.DataFrame();
                        context.Handler.RegisterContext(context);
                        break;
                    default:
